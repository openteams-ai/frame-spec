...
The body has no section headings, because `v0.2` does not define any (the working draft recognizes some optional ones and still requires none). Sections are worth adding when a Frame is long enough that a reader needs to navigate it, and not before.
