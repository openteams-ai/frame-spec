...
Import and activate the parent frame alone in Collab, an OpenTeams desktop app that applies Frames (see [../../docs/ecosystem.md](../../docs/ecosystem.md)), or paste it into another AI chat with your meeting notes, to get clean meeting notes — action items first, then themed discussion sections.
