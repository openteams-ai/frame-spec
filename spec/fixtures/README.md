...
| [composition/](composition/) | The three-Frame chain of section 5.5 resolves to exactly the outputs the rules predict, at the model level and under a profile that narrows `style` | `python tools/validate_frame.py --compose ...` diffed against `expected-*.json` |
