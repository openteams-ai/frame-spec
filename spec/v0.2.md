...
>
> This file is a frozen snapshot of the Frame Spec as released in `v0.2.0`. It will not change.
> The working draft of the spec lives in [frame-spec.md](frame-spec.md), and changes between releases are recorded in the [changelog](../CHANGELOG.md).
